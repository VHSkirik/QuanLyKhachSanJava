 ...
 * @author Admin
 */
public class AddUpdateNhanVien extends javax.swing.JDialog {

    /**
     * Creates new form AddUpdateNhanVien
     */
    public AddUpdateNhanVien(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 480, 140, 40));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 480, 140, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddUpdateNhanVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddUpdateNhanVien dialog = new AddUpdateNhanVien(new javax.swing.JFrame(), true);
